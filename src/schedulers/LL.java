...
public void UpdateReady(){
  ...
  public int TaskLeastLaxity(){
    ...
    for(int i=0;i<tam;i++)
        if(shortest==-1){
          shortest=i;
          aux=readytasks.get(i).deadline+readytasks.get(i).start-ctime-readytasks.get(i).timecompr;
        }else if((readytasks.get(i).deadline+readytasks.get(i).start-ctime-readytasks.get(i).timecompr)<aux){
...
/*
  public static void main(String[] args){
    ...
    for(int i=0;i<n;i++){
      ...
      d=lee.nextInt();
      ll.AddTask(new PeriodTask(s,d,t,i));
    }
